export default defineNuxtConfig({
    ...
    app: {
        ...
        head: {
            ...
            script: [
                {
                    src: 'https://www.googletagmanager.com/gtag/js?id=GTM-M58BJ94H',
                    async: true
                },
                {
                    src: '/ga.js'
                ...
                {
                    src: 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1195927112461155',
                    async: true,
